...
import com.example.articlekmp.ParentViewModel
...
class ArticleViewModel(
    ...
    private var _articleStateFlow = MutableStateFlow(ResponseState(loadingState = true))
    ...
    private fun displayArticles() {
        scope.launch {
            ...
            _articleStateFlow.emit(ResponseState(successState = articlesData))
        }
    }
